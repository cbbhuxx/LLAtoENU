...
if("TRUE" STREQUAL "TRUE")
  set(lla2enu_SOURCE_PREFIX /home/project/cbbhuxx_file/LLAtoENU/src/lla2enu)
  set(lla2enu_DEVEL_PREFIX /home/project/cbbhuxx_file/LLAtoENU/src/lla2enu/cmake-build-debug/devel)
  set(lla2enu_INSTALL_PREFIX "")
  set(lla2enu_PREFIX ${lla2enu_DEVEL_PREFIX})
else()
  set(lla2enu_SOURCE_PREFIX "")
  set(lla2enu_DEVEL_PREFIX "")
  set(lla2enu_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/project/cbbhuxx_file/LLAtoENU/src/lla2enu/include " STREQUAL " ")
  set(lla2enu_INCLUDE_DIRS "")
  set(_include_dirs "/home/project/cbbhuxx_file/LLAtoENU/src/lla2enu/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'chao <chao@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lla2enu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/project/cbbhuxx_file/LLAtoENU/src/lla2enu/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lla2enu_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "lla2enu")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/project/cbbhuxx_file/LLAtoENU/src/lla2enu/cmake-build-debug/devel/lib;/home/project/cbbhuxx_file/LLAtoENU/devel/lib;/home/project/ws_livox/devel/lib;/home/project/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
set(depends "roscpp;rospy;std_msgs;enu_msgs")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(lla2enu_EXPORTED_TARGETS ${${lla2enu_dep}_EXPORTED_TARGETS})
endforeach()
